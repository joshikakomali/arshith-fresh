        ...
        <div className="job-cards-list gsap-reveal">
          ...
          <div className="job-row-luxury" style={{ background: "#fff", border: "1px solid #e2e8f0" }}>
            <div className="job-row-title">
              ...
              <p style={{ color: "#475569" }}>IT Services | Bengaluru | Full-Time</p>
            </div>
          ...
          <div className="job-row-luxury" style={{ background: "#fff", border: "1px solid #e2e8f0" }}>
            <div className="job-row-title">
              ...
              <p style={{ color: "#475569" }}>IT Services | Bengaluru / Remote | Full-Time</p>
            </div>
            <a href="#apply" className="btn btn-primary" style={{ padding: "10px 24px" }}>Apply Now</a>
          </div>
          ...
          <div className="job-row-luxury" style={{ background: "#fff", border: "1px solid #e2e8f0" }}>
            <div className="job-row-title">
              ...
              <p style={{ color: "#475569" }}>Suntech Digital | Bengaluru | Full-Time</p>
            </div>
            <a href="#apply" className="btn btn-primary" style={{ padding: "10px 24px" }}>Apply Now</a>
          </div>
          ...
          <div className="job-row-luxury" style={{ background: "#fff", border: "1px solid #e2e8f0" }}>
            <div className="job-row-title">
              ...
              <p style={{ color: "#475569" }}>Web Development, UI/UX Design &amp; Digital Marketing | Freshers</p>
            </div>
