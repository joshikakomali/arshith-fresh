            ...
            return (
              ...
              >
                ...
                <div style={{ direction: "ltr" }}>
                  ...
                  <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", fontWeight: "600", fontSize: "14px", color: "var(--accent)" }}>
      ...
      <section className="light-contrast" style={{ borderBottom: "none" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px", alignItems: "center" }} className="gsap-reveal">
          <div>
            ...
            <p style={{ color: "#475569", marginBottom: "16px", fontSize: "16px" }}>
