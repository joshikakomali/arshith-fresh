      ...
      <section className="light-contrast">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "30px" }} className="gsap-reveal">
          <div style={{ background: "#fff", border: "1px solid #e2e8f0", padding: "40px", borderRadius: "var(--radius-lg)" }}>
            ...
            <p style={{ color: "#475569", fontSize: "14px" }}>Learn precise translation of web mockup templates (Figma/PSD) to functional, fluid codes across all viewpoints.</p>
          </div>
          ...
          <div style={{ background: "#fff", border: "1px solid #e2e8f0", padding: "40px", borderRadius: "var(--radius-lg)" }}>
            ...
            <p style={{ color: "#475569", fontSize: "14px" }}>Assemble production-level layouts, components libraries, and form validation codes to show employers.</p>
          </div>
          ...
          <div style={{ background: "#fff", border: "1px solid #e2e8f0", padding: "40px", borderRadius: "var(--radius-lg)" }}>
            ...
            <p style={{ color: "#475569", fontSize: "14px" }}>Learn technical communication and responsive parameters, helping you clear design-level interviews.</p>
          </div>
        </div>
      </section>
