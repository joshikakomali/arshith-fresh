    ...
    <footer className="ag-footer" id="footer">
      <div className="ag-footer-inner">
        ...
        <div className="ag-footer-cols">
          ...
          <div className="ag-footer-col">
            <h5>Businesses</h5>
            <ul>
              <li><a href="https://arshithfresh.com/" target="_blank" rel="noopener noreferrer">Arshith Fresh</a></li>
              <li><Link to="/services">Arshith Infotech</Link></li>
              <li><a href="https://suntechorganization.com/" target="_blank" rel="noopener noreferrer">Suntech Solutions</a></li>
              <li><a href="https://suntechorganization.com/" target="_blank" rel="noopener noreferrer">Suntech Digital</a></li>
            </ul>
          </div>
      ...
      <div className="ag-footer-bottom">
        <div className="ag-footer-bottom-inner">
          <p>&copy; {new Date().getFullYear()} Arshith Group. All rights reserved.</p>
          <div className="ag-footer-legal">
            <a href="#footer">Privacy Policy</a>
            <a href="#footer">Terms of Service</a>
            <a href="#footer">Legal Disclaimer</a>
          </div>
